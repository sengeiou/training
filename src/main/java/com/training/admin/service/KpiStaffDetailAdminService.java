...
//    public int dealXq(String month) {
//        logger.info(" =======   KpiStaffDetailService  dealXq  month = {} ",month);
...
//        logger.info(" dealXq   startDate = {} , endDate = {} , data.size = {} ",startDate,endDate,data.size());
...
//            }
//        }
//        logger.info(" getXks = {}  month = {} , data.size = {} ",xks,month,data.size());
//        return xks;
//    }
