...
import com.training.domain.UserAgent;
    ...
    public static UserAgent getUserAgent(String userAgent) {
        ...
        if (userAgent.contains("Windows")) {//主流应用靠前
            ...
            if (userAgent.contains("iPod")) {
                ua = judgeBrowser(userAgent, "iPod", null , null);//判断浏览器
            } else if (userAgent.contains("iPhone")) {
                ua = judgeBrowser(userAgent, "iPhone", null , null);//判断浏览器
            } else if (userAgent.contains("iPad")) {
                ua = judgeBrowser(userAgent, "iPad", null , null);//判断浏览器
            } else  if (userAgent.contains("iPad")) {
                ua = judgeBrowser(userAgent, "iPad", null , null);//判断浏览器
            } else {
                ua = judgeBrowser(userAgent, "Mac", null , null);//判断浏览器
            }

        } else if (userAgent.contains("Android")||userAgent.contains("android")) {
            ua = judgeBrowser(userAgent, "Android", null , null);//判断浏览器
        }
        if(userAgent.toLowerCase().contains("micromessenger")){
            ua.setIsWeixin(true);
        }else{
            ua.setIsWeixin(false);
        }
        return ua;
    }
