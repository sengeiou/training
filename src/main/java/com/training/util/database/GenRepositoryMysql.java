...
public class GenRepositoryMysql {
    ...
    //数据库连接
    private static final String URL ="jdbc:mysql://127.0.0.1:3306/training?rewriteBatchedStatements=true&allowMultiQueries=true&characterEncoding=utf-8&useSSL=true";
